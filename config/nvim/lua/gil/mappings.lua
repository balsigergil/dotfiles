...
--  See `:help hlsearch`
vim.keymap.set({ "i", "n", "s" }, "<Esc>", "<cmd>nohlsearch<CR><Esc>", { desc = "Clear highlights on search" })
...
vim.keymap.set("n", "<C-h>", "<C-w>h", { desc = "Move focus to the left widow", remap = true })
...
-- Save file
vim.keymap.set({ "i", "x", "n", "s" }, "<C-s>", "<cmd>w<CR><Esc>", { desc = "Save the current file" })
vim.keymap.set("n", "<leader>w", "<cmd>w<CR><Esc>", { desc = "Save the current file" })
...
vim.keymap.set("v", "<leader>cc", "gc", { desc = "Toggle comment", remap = true })
